...
class FancyTabBar extends StatefulWidget {
  final TabController customTabController;

  FancyTabBar({@required this.customTabController});
  @override
  _FancyTabBarState createState() => _FancyTabBarState(this.customTabController);
}
...
class _FancyTabBarState extends State<FancyTabBar>
 ...
 TabController _custTabController;
  _FancyTabBarState(TabController customTabController);

  @override
  void initState() {
    super.initState();

    _custTabController = this.widget.customTabController;
  ...
  _initAnimationAndStart(double from, double to) {
   ...
   _custTabController.index = currentSelected;
